...
for z in range(zlen):
    covmat = np.cov(hostmass[simzbins[z]], c[simzbins[z]])
    datacovmat = np.cov(datahostmass[datazbins[z]], datac[datazbins[z]])
...
plt.subplot(231)
plt.scatter(hostmass[zbin0], c[zbin0], alpha=0.6, color='blue')
plt.scatter(datahostmass[datazbin0], datac[datazbin0], alpha=0.8, color='red', marker='v')
plt.title('z = ' + str(zbins[0]))
plt.ylabel('c')
plt.xlim(7, 13)
plt.ylim(-0.3, 0.3)
plt.subplot(232)
plt.scatter(hostmass[zbin1], c[zbin1], alpha=0.6, color='blue', label='sim')
plt.scatter(datahostmass[datazbin1], datac[datazbin1], alpha=0.8, color='red', marker='v', label='obs')
plt.title('z = ' + str(zbins[1]))
# plt.legend()
plt.xlim(7, 13)
plt.ylim(-0.3, 0.3)
plt.subplot(233)
plt.scatter(hostmass[zbin2], c[zbin2], alpha=0.6, color='blue', label='sim')
plt.scatter(datahostmass[datazbin2], datac[datazbin2], alpha=0.8, color='red', marker='v', label='obs')
plt.title('z = ' + str(zbins[2]))
plt.legend()
plt.xlim(7, 13)
plt.ylim(-0.3, 0.3)
plt.subplot(234)
plt.scatter(hostmass[zbin3], c[zbin3], alpha=0.6, color='blue')
plt.scatter(datahostmass[datazbin3], datac[datazbin3], alpha=0.8, color='red', marker='v')
plt.title('z = ' + str(zbins[3]))
plt.xlim(7, 13)
plt.ylim(-0.3, 0.3)
plt.subplot(235)
plt.scatter(hostmass[zbin4], c[zbin4], alpha=0.6, color='blue')
plt.scatter(datahostmass[datazbin4], datac[datazbin4], alpha=0.8, color='red', marker='v')
plt.title('z = ' + str(zbins[4]))
plt.xlabel('host mass')
plt.xlim(7, 13)
plt.ylim(-0.3, 0.3)
plt.subplot(236)
plt.scatter(hostmass[zbin5], c[zbin5], alpha=0.6, color='blue')
plt.scatter(datahostmass[datazbin5], datac[datazbin5], alpha=0.8, color='red', marker='v')
