...
print(np.mean(muresabv) - np.mean(muresbel))
...
fig_size[0] = 16.0
fig_size[1] = 8.0
os.chdir('/Users/jaredhand/WFIRST_research/SN_distributions/mures_plots/lowz/sim4_mures')
...
plt.errorbar(zabvbins + 0.001, muresabvbins, yerr=muresabvbinserr,
             color='red', marker='D', alpha=0.7, label='sim>10', fmt='o')
plt.errorbar(zbelbins + 0.001, muresbelbins, yerr=muresbelbinserr,
             color='blue', marker='s', alpha=0.7, label='sim<10', fmt='o')
plt.errorbar(datazabvbins - 0.001, datamuresabvbins, yerr=datamuresabvbinserr,
             color='magenta', marker='D', alpha=0.7, label='data>10', fmt='o')
plt.errorbar(datazbelbins - 0.001, datamuresbelbins, yerr=datamuresbelbinserr,
...
plt.errorbar(zabvbins + 0.001, cabvbins, yerr=cabvbinserr,
             color='red', marker='D', alpha=0.7, label='sim>10', fmt='o')
plt.errorbar(zbelbins + 0.001, cbelbins, yerr=cbelbinserr,
             color='blue', marker='s', alpha=0.7, label='sim<10', fmt='o')
plt.errorbar(datazabvbins - 0.001, datacabvbins, yerr=datacabvbinserr,
             color='magenta', marker='D', alpha=0.7, label='data>10', fmt='o')
plt.errorbar(datazbelbins - 0.001, datacbelbins, yerr=datacbelbinserr,
             color='green', marker='s', alpha=0.7, label='data<10', fmt='o')
plt.xlim(0.005, 0.105)
plt.xlabel('redshift')
plt.ylabel('c')
...
plt.errorbar(zabvbins + 0.001, x1abvbins, yerr=x1abvbinserr,
             color='red', marker='D', alpha=0.7, label='sim>10', fmt='o')
plt.errorbar(zbelbins + 0.001, x1belbins, yerr=x1belbinserr,
             color='blue', marker='s', alpha=0.7, label='sim<10', fmt='o')
plt.errorbar(datazabvbins - 0.001, datax1abvbins, yerr=datax1abvbinserr,
             color='magenta', marker='D', alpha=0.7, label='data>10', fmt='o')
plt.errorbar(datazbelbins - 0.001, datax1belbins, yerr=datax1belbinserr,
             color='green', marker='s', alpha=0.7, label='data<10', fmt='o')
plt.xlim(0.005, 0.105)
# plt.ylim(-1.5, 1.5)
plt.xlabel('redshift')
