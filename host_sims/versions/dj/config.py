...
homedir = '/Users/jaredhand/WFIRST_research/SN_distributions/host_sims/versions/dj'  # working directory for scripts
...
sampletype = 0  # 0: weight map dist, 1: normal dist centered at 10, 2: uniform dist with bounds of 7, 13, 3: mass=8,12
